...
var _rluiten$elm_date_extra$Date_Extra_Config_Config_en_us$config = {
	...
	format: {date: '%-m/%-d/%Y', longDate: '%A, %B %d, %Y', time: '%-H:%M %p', longTime: '%-H:%M:%S %p', dateTime: '%-m/%-d/%Y %-I:%M %p', firstDayOfWeek: _elm_lang$core$Date$Mon}
};
...
var _user$project$Calendar$nextMonth = function (date) {
	return A3(_rluiten$elm_date_extra$Date_Extra_Duration$add, _rluiten$elm_date_extra$Date_Extra_Duration$Month, 1, date);
};
var _user$project$Calendar$prevMonth = function (date) {
	return A3(_rluiten$elm_date_extra$Date_Extra_Duration$add, _rluiten$elm_date_extra$Date_Extra_Duration$Month, -1, date);
};
var _user$project$Calendar$firstWeekOfMonth = function (date) {
	var dd = A2(
		_elm_lang$core$Debug$log,
		'D',
		_elm_lang$core$Date$day(date));
	var days = function () {
		var weekDay = _elm_lang$core$Date$dayOfWeek(
			_rluiten$elm_date_extra$Date_Extra_Core$toFirstOfMonth(date));
		return A2(_rluiten$elm_date_extra$Date_Extra_Core$daysBackToStartOfWeek, _elm_lang$core$Date$Sun, weekDay);
	}();
	return _elm_lang$core$Native_List.range(1, days);
};
var _user$project$Calendar$lastWeekOfMonth = function (date) {
	var daysInMonth = _rluiten$elm_date_extra$Date_Extra_Core$daysInMonthDate(date);
	var days = function () {
		var weekDay = _elm_lang$core$Date$dayOfWeek(
			_rluiten$elm_date_extra$Date_Extra_Core$lastOfMonthDate(date));
		return A2(_rluiten$elm_date_extra$Date_Extra_Core$daysBackToStartOfWeek, weekDay, _elm_lang$core$Date$Sun);
	}();
...
var _user$project$Calendar$splitWeeks = function (days) {
	if (_elm_lang$core$Native_Utils.eq(
		...
		var remainingDays = A2(_elm_lang$core$List$drop, 7, days);
		var thisWeek = A2(
			_elm_lang$core$List$repeat,
			1,
			A2(_elm_lang$core$List$take, 7, days));
		return A2(
			_elm_lang$core$List$append,
			thisWeek,
...
var _user$project$Calendar$viewMonth = F2(
	function (today, date) {
		var nextDays = function () {
			...
			return (_elm_lang$core$Native_Utils.cmp(
				_elm_lang$core$List$length(days),
				7) < 0) ? days : _elm_lang$core$Native_List.fromArray(
				[]);
		}();
		var currentDays = _elm_lang$core$Native_List.range(
			1,
			_rluiten$elm_date_extra$Date_Extra_Core$daysInMonthDate(date));
		var previousDays = function () {
			var days = _user$project$Calendar$lastWeekOfMonth(
...
var _user$project$Calendar$viewControls = function (model) {
	var year = _elm_lang$core$Basics$toString(
		_elm_lang$core$Date$year(model.viewDate));
	var month = _rluiten$elm_date_extra$Date_Extra_I18n_I_en_us$monthName(
		_elm_lang$core$Date$month(model.viewDate));
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onClick(_user$project$Calendar$PreviousMonth)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('‹')
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onClick(_user$project$Calendar$NextMonth)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('›')
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_user$project$Calendar$viewControls(model),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
					[
...
var _user$project$Calendar$main = {
	main: _elm_lang$html$Html_App$beginnerProgram(
		{model: _user$project$Calendar$emptyModel, view: _user$project$Calendar$view, update: _user$project$Calendar$update})
};

var Elm = {};
Elm['Calendar'] = Elm['Calendar'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Calendar'], 'Calendar', typeof _user$project$Calendar$main === 'undefined' ? null : _user$project$Calendar$main);
